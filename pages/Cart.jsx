...
const total=() => {
    let totalPrice = 0
    cart.forEach((item) => {
        totalPrice +=  +(item.salePrice || item.originalPrice * item.quantity).toFixed(2)
    })
    return totalPrice
   ...
   <div id="books__body">
    <main id="books__main">
        <div className="books__container">
            <div className="row">
                <div className="book__selected--top column">
                                    ...
                                    cart.map((book) => {
                                      return  (
                                        ...
                                        <div className="cart__quantity">
                                            <input type="number" min={0} max={99} className='cart__input' onChange={(event) => changeQuantity(book, event.target.value)} value={book.quantity}/>
                                        </div>
